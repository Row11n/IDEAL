...
def parse_args():
    ...
    parser.add_argument("--checkpoint", type=str, default="path/to/ckpt.pt", help="Path to training checkpoint (.pt)")
    parser.add_argument("--out", type=str,default= "path/to/ckpt.pth", help="Destination .pth path for model-only weights")
